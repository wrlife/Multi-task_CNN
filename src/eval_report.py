...
sys.path.insert(0,'/home/z003xr2y/data/Multi-task_CNN/src/py_img_seg_eval/')
...
def evaluation(inputs,model,checkpoint_dir,with_seg,worksheet,row, method,thresh):
    ...
    imageloader = DataLoader('/home/z003xr2y/data/data/tfrecords_hr_filldepth_val/',
                                5,
                                img_height, 
                                img_width,
                                'valid')
...
for thresh in range(2000,20001,2000):
    ...
    #evaluation("IR","single","/home/z003xr2y/data/Multi-task_CNN/checkpoints_IR_single_hr/",False,worksheet,row+2,"IR",thresh)
    #evaluation("IR","pose","/home/z003xr2y/data/Multi-task_CNN/checkpoints_IR_hr_pose/",False,worksheet,row+3,"IR+pose",thresh)
